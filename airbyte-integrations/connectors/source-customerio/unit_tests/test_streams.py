...
import pytest
from source_customerio.source import CustomerioStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CustomerioStream, "path", "v0/example_endpoint")
    mocker.patch.object(CustomerioStream, "primary_key", "test_primary_key")
    mocker.patch.object(CustomerioStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CustomerioStream()
